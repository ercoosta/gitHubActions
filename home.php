...
<body class="bg-gray-800">
  <div class="container mx-auto max-w-sm h-screen flex flex-col space-y-4 justify-center items-center ">
    ...
    <div class="bg-white font-semibold text-center rounded-3xl border shadow-lg p-10 w-full">
      <img class="mb-3 w-32 h-32 rounded-full shadow-lg mx-auto" src="36087036_1954869781470355_898582861416759296_n.jpg" alt="product designer">
      <h1 class="text-lg text-gray-700"> Edson Costa </h1>
    ...
    <div class="bg-white w-full flex items-center p-2 rounded-xl shadow border">
      <div class="relative flex items-center space-x-4">
        <img src="./181862423_446812420482650_505407805707620970_n.jpg" alt="Edson Costa" class="w-16 h-16 rounded-full" />
      </div>
      <div class="flex-grow p-3">
        <div class="font-semibold text-gray-700">Anderson Romão</div>
